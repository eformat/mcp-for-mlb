...
CHAINLIT_DB_PATH = os.environ.get("CHAINLIT_DB_PATH", "/app/data/chainlit.db")
os.makedirs(os.path.dirname(CHAINLIT_DB_PATH), exist_ok=True)

_DB_CONNINFO = f"sqlite+aiosqlite:///{CHAINLIT_DB_PATH}"
...
_EXPECTED_COLUMNS = {
    ...
    "threads": ["id", "name", "createdAt", "userId", "userIdentifier", "tags", "metadata"],
